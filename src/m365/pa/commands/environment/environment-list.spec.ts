...
describe(commands.ENVIRONMENT_LIST, () => {
  ...
  it("retrieves Microsoft App environments (debug)", async () => {
    const env: any = {
      value: [
        {
          id: "/providers/Microsoft.PowerApps/environments/Default-2ca3eaa5-140f-4175-9563-2172edf9f447",
          name: "Default-2ca3eaa5-140f-4175-9563-2172edf9f447",
          location: "europe",
          type: "Microsoft.PowerApps/environments",
          properties: {
            azureRegionHint: "westeurope",
            displayName: "Contoso (default) (contoso)",
            ...
            lastModifiedBy: {
              ...
              email: "administrator@contoso.nl",
              type: "User",
              tenantId: "2ca3eaa5-140f-4175-9563-2172edf9f447",
              userPrincipalName: "administrator@contoso.nl",
            },
            ...
            runtimeEndpoints: {
              "microsoft.BusinessAppPlatform":
                "https://europe.api.bap.microsoft.com",
              "microsoft.CommonDataModel":
                "https://europe.api.cds.microsoft.com",
              ...
              "microsoft.ApiManagement":
                "https://management.EUR.azure-apihub.net",
            },
            linkedEnvironmentMetadata: {
              type: "Dynamics365Instance",
              resourceId: "6d590664-6f39-41f4-9e8b-e95bc6bb1f1f",
              friendlyName: "Contoso (default)",
              uniqueName: "org185e622f",
              domainName: "contoso",
              version: "9.2.20122.00144",
              instanceUrl: "https://contoso.crm4.dynamics.com/",
              instanceApiUrl: "https://contoso.api.crm4.dynamics.com",
              baseLanguage: 1033,
              instanceState: "Ready",
              createdTime: "2018-11-14T10:17:47.033Z",
              modifiedTime: "2021-01-27T18:59:34.0883701Z",
              hostNameSuffix: "crm4.dynamics.com",
              bapSolutionId: "00000001-0000-0000-0001-00000000009b",
              creationTemplates: ["D365_CDS"],
              webApiVersion: "v9.0",
            },
            retentionPeriod: "P7D",
    ...
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        (opts.url as string).indexOf(
          `/providers/Microsoft.PowerApps/environments?api-version=2017-08-01`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
