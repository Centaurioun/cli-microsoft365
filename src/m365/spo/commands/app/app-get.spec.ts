...
describe(commands.APP_GET, () => {
  ...
  it("retrieves information about the app with the specified id from the tenant app catalog (debug)", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      ...
      if (
        (opts.url as string).indexOf(
          `/_api/web/tenantappcatalog/AvailableApps/GetById('b2307a39-e878-458b-bc90-03bc578531d6')`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
    ...
    await command.action(logger, {
      options: { debug: true, id: "b2307a39-e878-458b-bc90-03bc578531d6" },
    });
    assert(
  ...
  it("retrieves information about the app with the specified id from the site app catalog (debug)", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      ...
      if (
        (opts.url as string).indexOf(
          `/_api/web/sitecollectionappcatalog/AvailableApps/GetById('b2307a39-e878-458b-bc90-03bc578531d6')`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
    ...
    await command.action(logger, {
      options: {
        ...
        appCatalogUrl: "https://contoso-admin.sharepoint.com",
      },
    });
    assert(
      loggerLogSpy.calledWith({
  ...
  it("retrieves information about the app with the specified id from the tenant app catalog", async () => {
    ...
    await command.action(logger, {
      options: { id: "b2307a39-e878-458b-bc90-03bc578531d6" },
    });
    assert(
      loggerLogSpy.calledWith({
        ID: "b2307a39-e878-458b-bc90-03bc578531d6",
  ...
  it("retrieves information about the app with the specified name from the specified tenant app catalog", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      ...
      if (
        opts.url ===
        `https://contoso.sharepoint.com/sites/apps/_api/web/getfolderbyserverrelativeurl('AppCatalog')/files('solution.sppkg')?$select=UniqueId`
      ) {
  ...
  it("retrieves information about the app with the specified name from the specified site app catalog", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      ...
      if (
        opts.url ===
        `https://contoso.sharepoint.com/sites/site1/_api/web/getfolderbyserverrelativeurl('AppCatalog')/files('solution.sppkg')?$select=UniqueId`
      ) {
        return { UniqueId: "b2307a39-e878-458b-bc90-03bc578531d6" };
      }
    ...
    await command.action(logger, {
      options: {
        name: "solution.sppkg",
        appCatalogScope: "sitecollection",
        appCatalogUrl: "https://contoso.sharepoint.com/sites/site1",
      },
    });
    assert(
      loggerLogSpy.calledWith({
  ...
  it("retrieves information about the app with the specified name with auto-discovered tenant app catalog (debug)", async () => {
    ...
    await command.action(logger, {
      options: { debug: true, name: "solution.sppkg" },
    });
    assert(
      loggerLogSpy.calledWith({
        ID: "b2307a39-e878-458b-bc90-03bc578531d6",
  ...
  it("should handle getfolderbyserverrelativeurl error", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        opts.url ===
        `https://contoso.sharepoint.com/_api/web/getfolderbyserverrelativeurl('AppCatalog')/files('solution.sppkg')?$select=UniqueId`
      ) {
        throw {
          error: {
            "odata.error": {
            ...
            error: {
              "odata.error": {
                ...
                message: {
                  lang: "en-US",
                  value:
                    "Exception of type 'Microsoft.SharePoint.Client.ResourceNotFoundException' was thrown.",
                },
              },
            },
          };
  ...
  it("passes validation when the id option specified", async () => {
    const actual = await command.validate(
      { options: { id: "f8b52a45-61d5-4264-81c9-c3bbd203e7d0" } },
      commandInfo,
    );
  ...
  it("fails validation when both the id and the name options specified", async () => {
    const actual = await command.validate(
      {
        options: {
          id: "f8b52a45-61d5-4264-81c9-c3bbd203e7d0",
          name: "solution.sppkg",
        },
      },
      commandInfo,
  ...
  it("fails validation when the specified appCatalogUrl is not a valid SharePoint URL", async () => {
    const actual = await command.validate(
      { options: { name: "solution.sppkg", appCatalogUrl: "url" } },
      commandInfo,
    );
    assert.notStrictEqual(actual, true);
  });
  ...
  it("fails validation when invalid scope is specified", async () => {
    const actual = await command.validate(
      {
        options: {
          id: "dd20afdf-d7fd-4662-a443-b69e65a72bd4",
          appCatalogUrl: "https://contoso.sharepoint.com",
          appCatalogScope: "foo",
        },
      },
    ...
    const actual = await command.validate(
      {
        options: {
          id: "dd20afdf-d7fd-4662-a443-b69e65a72bd4",
          appCatalogScope: "sitecollection",
          appCatalogUrl: "contoso.sharepoint.com",
        },
      },
      commandInfo,
    );
  ...
  it("passes validation when no scope is specified", async () => {
    const actual = await command.validate(
      { options: { id: "dd20afdf-d7fd-4662-a443-b69e65a72bd4" } },
      commandInfo,
    );
    assert.strictEqual(actual, true);
  });
