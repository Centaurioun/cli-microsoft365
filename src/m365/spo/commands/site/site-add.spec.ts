...
describe(commands.SITE_ADD, () => {
  ...
  beforeEach(() => {
    ...
    sinon.stub(spo, "ensureFormDigest").callsFake(() => {
  ...
  afterEach(() => {
    ...
    sinonUtil.restore([request.post, global.setTimeout, spo.ensureFormDigest]);
  });
  ...
  it("creates modern team site using the correct endpoint", async () => {
    sinon.stub(request, "post").callsFake((opts) => {
      if (
        (opts.url as string).indexOf(`/_api/GroupSiteManager/CreateGroupEx`) >
        -1
      ) {
  ...
  it("sets specified title for modern team site", async () => {
    ...
    await command.action(logger, {
      options: { type: "TeamSite", title: expected },
    });
  ...
  it("sets specified alias for modern team site", async () => {
    ...
    await command.action(logger, {
      options: { type: "TeamSite", alias: expected },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("sets modern team site group type to public when isPublic specified", async () => {
    ...
    await command.action(logger, {
      options: { type: "TeamSite", isPublic: true },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("sets specified description for modern team site", async () => {
    ...
    await command.action(logger, {
      options: { type: "TeamSite", description: expected },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("sets specified classification for modern team site", async () => {
    ...
    await command.action(logger, {
      options: { type: "TeamSite", classification: expected },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("creates modern team site with the specified language", async () => {
    ...
    sinon.stub(request, "post").callsFake((opts) => {
      if (
        ...
        actual =
          opts.data.optionalParams.CreationOptions.results.indexOf(
            "SPSiteLanguage:1033",
          ) > -1;
        return Promise.resolve({ ErrorMessage: null });
      }
  ...
  it("creates modern team site with the specified owner", async () => {
    ...
    await command.action(logger, {
      options: { type: "TeamSite", owners: "admin@contoso.com" },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("creates modern team site with the specified owners", async () => {
    const expected = JSON.stringify({
      results: ["admin@contoso.com", "steve@contoso.com"],
    });
    let actual = "";
    sinon.stub(request, "post").callsFake((opts) => {
      if (
  ...
  it("correctly handles error when modern team site with the specified alias already exists", async () => {
    sinon.stub(request, "post").callsFake((opts) => {
      if (
        ...
        return Promise.resolve({
          ErrorMessage: "The group alias already exists.",
        });
      }
    ...
    await assert.rejects(
      command.action(logger, { options: { type: "TeamSite" } } as any),
      new CommandError("The group alias already exists."),
    );
  });
  ...
  it("correctly handles OData error when creating a modern team site", async () => {
    sinon.stub(request, "post").callsFake(() => {
      return Promise.reject({
        error: {
          "odata.error": { message: { value: "An error has occurred" } },
        },
      });
    });
  ...
  it("sets specified title for communication site", async () => {
    ...
    await assert.rejects(
      command.action(logger, {
        options: { type: "CommunicationSite", title: expected },
      }),
    );
    assert.strictEqual(actual, expected);
  });
  ...
  it("sets specified url for communication site", async () => {
    ...
    await command.action(logger, {
      options: { type: "CommunicationSite", url: expected },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("enables sharing files with external users in communication site when shareByEmailEnabled specified", async () => {
    ...
    await command.action(logger, {
      options: { type: "CommunicationSite", shareByEmailEnabled: true },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("sets specified description for communication site", async () => {
    ...
    await command.action(logger, {
      options: { type: "CommunicationSite", description: expected },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("sets specified classification for communication site", async () => {
    ...
    await command.action(logger, {
      options: { type: "CommunicationSite", classification: expected },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("sets correct id for the Topic communication site site design", async () => {
    ...
    await command.action(logger, {
      options: { type: "CommunicationSite", siteDesign: "Topic" },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("sets correct id for the Showcase communication site site design", async () => {
    ...
    await command.action(logger, {
      options: { type: "CommunicationSite", siteDesign: "Showcase" },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("sets correct id for the Blank communication site site design", async () => {
    ...
    await command.action(logger, {
      options: { type: "CommunicationSite", siteDesign: "Blank" },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("sets specified communication site site design id", async () => {
    ...
    await command.action(logger, {
      options: { type: "CommunicationSite", siteDesignId: expected },
    });
    assert.strictEqual(actual, expected);
  });
  ...
  it("creates communication site using the specified language", async () => {
    ...
    await command.action(logger, {
      options: { type: "CommunicationSite", lcid: expected },
    });
    assert.strictEqual(actual, expected);
  });
            ...
            JSON.stringify([
              {
                ...
                ErrorInfo: null,
                TraceCorrelationId: "d53a489e-c0c0-5000-58fc-d03b433dca89",
              },
              4,
              {
                IsNull: false,
              ...
              7,
              {
                ...
                _ObjectIdentity_:
                  "d53a489e-c0c0-5000-58fc-d03b433dca89|908bed80-a04a-4433-b4a0-883d9847d110:67753f63-bc14-4012-869e-f808a43fe023\nTenant",
                ...
                StorageQuotaAllocated: 10669260800,
  ...
  it("creates classic site with full options. doesn't wait for completion (debug)", async () => {
    ...
    await command.action(logger, {
      options: {
        ...
        owners: "admin@contoso.com",
        lcid: 1033,
        webTemplate: "PUBLISHING#0",
        resourceQuota: 100,
        resourceQuotaWarningLevel: 90,
        storageQuota: 300,
        storageQuotaWarningLevel: 275,
      },
    });
    assert(loggerLogToStderrSpy.called);
  });
            ...
            JSON.stringify([
              {
                ...
                ErrorInfo: {
                  ErrorMessage:
                    "Cannot get site https:\u002f\u002fcontoso.sharepoint.com\u002fsites\u002fsite4.",
                  ErrorValue: null,
                  TraceCorrelationId: "e13c489e-2026-5000-8242-7ec96d02ba1d",
                  ErrorCode: -1,
                  ErrorTypeName:
                    "Microsoft.Online.SharePoint.Common.SpoNoSiteException",
                },
                TraceCorrelationId: "e13c489e-2026-5000-8242-7ec96d02ba1d",
              },
            ]),
            ...
            JSON.stringify([
              {
                ...
                LibraryVersion: "16.0.7324.1200",
                ErrorInfo: null,
                TraceCorrelationId: "c340489e-80cc-5000-c5b4-01b2ce71e9bf",
              },
              197,
              {
                IsNull: false,
              ...
              200,
              {
                ...
                _ObjectIdentity_:
                  "c340489e-80cc-5000-c5b4-01b2ce71e9bf|908bed80-a04a-4433-b4a0-883d9847d110:67753f63-bc14-4012-869e-f808a43fe023\nSiteProperties\nhttps%3a%2f%2fcontoso.sharepoint.com%2fsites%2fteam",
                AllowDownloadingNonWebViewableFiles: true,
                AllowEditing: true,
                ...
                DisableFlows: 2,
                HasHolds: false,
                LastContentModifiedDate: "/Date(2018,1,7,19,9,58,513)/",
                Lcid: 1033,
                LockIssue: null,
                LockState: "Unlock",
                NewUrl: "",
            ...
            JSON.stringify([
              {
                ...
                LibraryVersion: "16.0.7324.1200",
                ErrorInfo: null,
                TraceCorrelationId: "e13c489e-304e-5000-8242-705e26a87302",
              },
              185,
              {
                IsNull: false,
              ...
              186,
              {
                _ObjectType_:
                  "Microsoft.Online.SharePoint.TenantAdministration.SpoOperation",
                _ObjectIdentity_:
                  "e13c489e-304e-5000-8242-705e26a87302|908bed80-a04a-4433-b4a0-883d9847d110:67753f63-bc14-4012-869e-f808a43fe023\nSpoOperation\nRemoveDeletedSite\n636536266495764941\nhttps%3a%2f%2fcontoso.sharepoint.com%2fsites%2fteam\ncb09f194-0ee7-4c48-a44f-8c112fff4d4e",
                IsComplete: true,
                PollingInterval: 15000,
              },
            ]),
            ...
            JSON.stringify([
              {
                ...
                ErrorInfo: {
                  ErrorMessage:
                    "Cannot get site https:\u002f\u002fcontoso.sharepoint.com\u002fsites\u002fteam.",
                  ErrorValue: null,
                  TraceCorrelationId: "e13c489e-2026-5000-8242-7ec96d02ba1d",
                  ErrorCode: -1,
                  ErrorTypeName:
            ...
            JSON.stringify([
              {
                ...
                LibraryVersion: "16.0.7324.1200",
                ErrorInfo: null,
                TraceCorrelationId: "e13c489e-8041-5000-8242-77f6c560fa5e",
              },
              181,
              {
                IsNull: false,
              ...
              182,
              {
                ...
                _ObjectIdentity_:
                  "e13c489e-8041-5000-8242-77f6c560fa5e|908bed80-a04a-4433-b4a0-883d9847d110:67753f63-bc14-4012-869e-f808a43fe023\nDeletedSiteProperties\nhttps%3a%2f%2fcontoso.sharepoint.com%2fsites%2fteam",
                DaysRemaining: 30,
                DeletionTime: "/Date(2018,1,7,18,57,20,530)/",
                SiteId: "/Guid(cb09f194-0ee7-4c48-a44f-8c112fff4d4e)/",
                Status: "Recycled",
                StorageMaximumLevel: 26214400,
                Url: "https:\u002f\u002fcontoso.sharepoint.com\u002fsites\u002fteam",
                UserCodeMaximumLevel: 0,
            ...
            JSON.stringify([
              {
                ...
                ErrorInfo: {
                  ErrorMessage:
                    "A site already exists at url https:\u002f\u002fcontoso.sharepoint.com\u002fsites\u002fteam.",
                  ErrorValue: null,
    ...
    const actual = await command.validate(
      {
        options: {
          ...
          url: "https://contoso.sharepoint.com/sites/team",
          title: "Team",
          owners: "admin@contoso.com, admin2@contoso.com",
          timeZone: 4,
        },
      },
      commandInfo,
