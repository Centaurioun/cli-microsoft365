...
describe(commands.SITE_SET, () => {
  ...
  before(() => {
    ...
    auth.service.tenantId =
      "a61d499e-50aa-5000-8242-7169ab88ce08|908bed80-a04a-4433-b4a0-883d9847d110:67753f63-bc14-4012-869e-f808a43fe023&#xA;Tenant";
  });
  ...
  it("fails validation if specified id is not a valid GUID", async () => {
    const actual = await command.validate(
      { options: { url: "https://contoso.sharepoint.com", id: "ABC" } },
      commandInfo,
    );
    assert.notStrictEqual(actual, true);
  });
  ...
  it("fails validation if siteLogoUrl is not a string", async () => {
    const actual = await command.validate(
      {
        options: {
          url: "https://contoso.sharepoint.com/sites/logo",
          siteLogoUrl: true,
        },
      },
      commandInfo,
    ...
    const actual = await command.validate(
      {
        options: {
          ...
          title: "Team",
          resourceQuota: 100,
          resourceQuotaWarningLevel: 90,
          storageQuota: 100,
          storageQuotaWarningLevel: 90,
  ...
  it("passes validation if url and empty classification specified", async () => {
    const actual = await command.validate(
      {
        options: { url: "https://contoso.sharepoint.com", classification: "" },
      },
      commandInfo,
    );
    assert.strictEqual(actual, true);
  ...
  it("passes validation if url and disableFlows true specified", async () => {
    const actual = await command.validate(
      {
        options: { url: "https://contoso.sharepoint.com", disableFlows: true },
      },
      commandInfo,
    );
    assert.strictEqual(actual, true);
  ...
  it("passes validation if url and disableFlows false specified", async () => {
    const actual = await command.validate(
      {
        options: { url: "https://contoso.sharepoint.com", disableFlows: false },
      },
      commandInfo,
    );
    assert.strictEqual(actual, true);
  ...
  it("passes validation if true specified for isPublic", async () => {
    const actual = await command.validate(
      { options: { url: "https://contoso.sharepoint.com", isPublic: true } },
      commandInfo,
    );
    assert.strictEqual(actual, true);
  });
  ...
  it("passes validation if false specified for isPublic", async () => {
    const actual = await command.validate(
      { options: { url: "https://contoso.sharepoint.com", isPublic: false } },
      commandInfo,
    );
    assert.strictEqual(actual, true);
  });
    ...
    const actual = await command.validate(
      {
        options: {
          url: "https://contoso.sharepoint.com",
          siteDesignId: "eb2f31da-9461-4fbf-9ea1-9959b134b89e",
        },
      },
      commandInfo,
    );
  ...
  it("updates title of the specified site", async () => {
    sinon.stub(request, "get").callsFake((opts) => {
      if (
        opts.url ===
        "https://contoso.sharepoint.com/sites/Sales/_api/site?$select=GroupId,Id"
      ) {
            ...
            JSON.stringify([
              {
                ...
                LibraryVersion: "16.0.7331.1205",
                ErrorInfo: null,
                TraceCorrelationId: "54d8499e-b001-5000-cb83-9445b3944fb9",
              },
              14,
              {
                IsNull: false,
              ...
              {
                _ObjectIdentity_:
                  "54d8499e-b001-5000-cb83-9445b3944fb9|908bed80-a04a-4433-b4a0-883d9847d110:67753f63-bc14-4012-869e-f808a43fe023\nSiteProperties\nhttps%3a%2f%2fcontoso.sharepoint.com%2fsites%2fteam",
              },
              16,
              {
                _ObjectType_:
  ...
  it("updates site title. doesn't wait for completion (debug)", async () => {
    sinon.stub(request, "get").callsFake((opts) => {
      if (
        opts.url ===
        "https://contoso.sharepoint.com/sites/team/_api/site?$select=GroupId,Id"
      ) {
        return Promise.resolve({
          Id: "255a50b2-527f-4413-8485-57f4c17a24d1",
          GroupId: "00000000-0000-0000-0000-000000000000",
        ...
        if (
          ...
          return Promise.resolve(
            JSON.stringify([
              {
                SchemaVersion: "15.0.0.0",
                LibraryVersion: "16.0.7324.1200",
                ErrorInfo: null,
                TraceCorrelationId: "803b489e-9066-5000-58fc-dc40eb096913",
              },
              39,
              {
                _ObjectType_:
                  "Microsoft.Online.SharePoint.TenantAdministration.SpoOperation",
                _ObjectIdentity_:
                  "803b489e-9066-5000-58fc-dc40eb096913|908bed80-a04a-4433-b4a0-883d9847d110:67753f63-bc14-4012-869e-f808a43fe023\nSpoOperation\nSetSite\n636540580851601240\nhttps%3a%2f%2fcontoso.sharepoint.com%2fsites%2fteam\n00000000-0000-0000-0000-000000000000",
                IsComplete: true,
  ...
  it("updates title of the specified groupified site", async () => {
    ...
    sinon.stub(request, "post").callsFake((opts) => {
      if (
        opts.url ===
          "https://contoso-admin.sharepoint.com/_api/SPOGroup/UpdateGroupPropertiesBySiteId" &&
  ...
  it("updates isPublic property of the specified groupified site", async () => {
    ...
    executeCommandSpy = sinon
      .stub(Cli, "executeCommand")
      .callsFake(() => Promise.resolve());
    sinon.stub(request, "patch").callsFake((opts) => {
      if (
        opts.url ===
        "https://graph.microsoft.com/v1.0/groups/e10a459e-60c8-4000-8240-a68d6a12d39e"
      ) {
        return Promise.resolve();
      }
    ...
    assert(
      executeCommandSpy.calledWith(aadO365GroupSetCommand, {
        options: options,
      }),
    );
  });
        ...
        if (
          ...
          return Promise.resolve(
            JSON.stringify([
              {
                SchemaVersion: "15.0.0.0",
                LibraryVersion: "16.0.7407.1203",
                ErrorInfo: null,
                TraceCorrelationId: "e0cf4a9e-301d-5000-8242-77fc92412701",
              },
              9,
              {
                IsNull: false,
              ...
              {
                _ObjectIdentity_:
                  "e0cf4a9e-301d-5000-8242-77fc92412701|908bed80-a04a-4433-b4a0-883d9847d110:67753f63-bc14-4012-869e-f808a43fe023\nSiteProperties\nhttps%3a%2f%2fcontoso.sharepoint.com%2fsites%2fteam",
              },
              11,
              {
                _ObjectType_:
            ...
            JSON.stringify([
              {
                ...
                LibraryVersion: "16.0.7331.1205",
                ErrorInfo: null,
                TraceCorrelationId: "b3d8499e-1079-5000-cb83-9da72405dfa6",
              },
              48,
              {
                IsNull: false,
  ...
  it("updates the classification of the specified site", async () => {
    ...
    sinon.stub(request, "post").callsFake((opts) => {
      if (
        (opts.url as string).indexOf(`/_vti_bin/client.svc/ProcessQuery`) >
          -1 &&
        opts.data ===
  ...
  it("updates the classification of the specified groupified site (debug)", async () => {
    ...
    assert(
      loggerLogToStderrSpy.calledWith(
        `Site attached to group e10a459e-60c8-4000-8240-a68d6a12d39e`,
      ),
    );
  });
  ...
  it("updates owners of the specified groupified site with one owner", async () => {
    sinon.stub(request, "get").callsFake((opts) => {
      ...
      if (
        opts.url ===
        `https://graph.microsoft.com/v1.0/users?$filter=userPrincipalName eq 'admin@contoso.onmicrosoft.com'&$select=id`
      ) {
        return Promise.resolve({
          value: [{ id: "b17ff355-cc97-4b90-9b46-e33d0d70d729" }],
        });
      }
    ...
    sinon.stub(request, "post").callsFake((opts) => {
      if (
        opts.url ===
        `https://contoso-admin.sharepoint.com/_api/SP.Directory.DirectorySession/Group('e10a459e-60c8-4000-8240-a68d6a12d39e')/Owners/Add(objectId='b17ff355-cc97-4b90-9b46-e33d0d70d729', principalName='')`
      ) {
        return Promise.resolve();
      }
  ...
  it("updates owners of the specified groupified site with one owner (debug)", async () => {
    ...
    assert(
      loggerLogToStderrSpy.calledWith(
        "Retrieving user information to set group owners...",
      ),
    );
  });
  ...
  it("updates owners of the specified groupified site with multiple owners", async () => {
    sinon.stub(request, "get").callsFake((opts) => {
      ...
      if (
        opts.url ===
        `https://graph.microsoft.com/v1.0/users?$filter=userPrincipalName eq 'admin1@contoso.onmicrosoft.com' or userPrincipalName eq 'admin2@contoso.onmicrosoft.com'&$select=id`
      ) {
        return Promise.resolve({
          value: [
    ...
    sinon.stub(request, "post").callsFake((opts) => {
      if (
        opts.url ===
        `https://contoso-admin.sharepoint.com/_api/SP.Directory.DirectorySession/Group('e10a459e-60c8-4000-8240-a68d6a12d39e')/Owners/Add(objectId='b17ff355-cc97-4b90-9b46-e33d0d70d728', principalName='')`
      ) {
        return Promise.resolve();
      }
      if (
    ...
    await command.action(logger, {
      options: {
        owners: "admin1@contoso.onmicrosoft.com,admin2@contoso.onmicrosoft.com",
        url: "https://contoso.sharepoint.com/sites/Sales",
      },
    } as any);
  });
  ...
  it("updates owners of the specified groupified site with multiple owners with extra spaces", async () => {
    ...
    await command.action(logger, {
      options: {
        owners:
          " admin1@contoso.onmicrosoft.com , admin2@contoso.onmicrosoft.com ",
        url: "https://contoso.sharepoint.com/sites/Sales",
      },
    } as any);
  });
      ...
      if (
        ...
        return Promise.resolve(
          JSON.stringify([
            {
              SchemaVersion: "15.0.0.0",
              LibraryVersion: "16.0.8929.1227",
              ErrorInfo: null,
              TraceCorrelationId: "e4f2e59e-c0a9-0000-3dd0-1d8ef12cc742",
            },
            2,
            {
              IsNull: false,
            ...
            {
              _ObjectIdentity_:
                "b61d6a9f-d0ca-0000-4814-29cf3242c81a|908bed80-a04a-4433-b4a0-883d9847d110:095efa67-57fa-40c7-b7cc-e96dc3e5780c\nSiteProperties\nhttps%3a%2f%contoso.sharepoint.com%2fsites%2fSales",
            },
          ]),
        );
      }
  ...
  it("throws error when trying to update isPublic property on a non-groupified site", async () => {
    ...
    await assert.rejects(
      ...
      new CommandError(
        `The isPublic option can't be set on a site that is not groupified`,
      ),
    );
  });
  ...
  it("correctly handles error while updating isPublic property of the specified groupified site", async () => {
    ...
    executeCommandSpy = sinon
      .stub(Cli, "executeCommand")
      .callsFake(() =>
        Promise.reject(new CommandError("An error has occurred")),
      );
  ...
  it("skips users that could not be resolves when setting groupified site owners", async () => {
    sinon.stub(request, "get").callsFake((opts) => {
      ...
      if (
        ...
        return Promise.resolve({
          value: [{ id: "b17ff355-cc97-4b90-9b46-e33d0d70d728" }],
        });
      }
  ...
  it("applies site design to the specified site", async () => {
    ...
    assert(
      executeCommandSpy.calledWith(spoSiteDesignApplyCommand, {
        options: options,
      }),
    );
  });
  ...
  it("applies site relative logo url to the specified site", async () => {
    ...
    sinon.stub(request, "get").callsFake((opts) => {
      if (
        opts.url ===
        "https://contoso.sharepoint.com/sites/logo/_api/site?$select=GroupId,Id"
      ) {
        return Promise.resolve({
          Id: "255a50b2-527f-4413-8485-57f4c17a24d1",
          GroupId: "e10a459e-60c8-4000-8240-a68d6a12d39e",
    ...
    sinon.stub(request, "post").callsFake((opts) => {
      if (
        opts.url ===
        "https://contoso.sharepoint.com/sites/logo/_api/siteiconmanager/setsitelogo"
      ) {
        data = opts.data;
        return Promise.resolve();
      }
    ...
    await command.action(logger, {
      options: {
        url: "https://contoso.sharepoint.com/sites/logo",
        siteLogoUrl: "/sites/logo/SiteAssets/parker-ms-1200.png",
      },
    });
    assert.strictEqual(
      data.relativeLogoUrl,
      "/sites/logo/SiteAssets/parker-ms-1200.png",
    );
  });
  ...
  it("applies site absolute logo url to the specified site", async () => {
    ...
    await command.action(logger, {
      options: {
        url: "https://contoso.sharepoint.com/sites/logo",
        siteLogoUrl:
          "https://contoso.sharepoint.com/sites/logo/SiteAssets/parker-ms-1200.png",
      },
    });
    assert.strictEqual(
      data.relativeLogoUrl,
  ...
  it("correctly handles site not found error", async () => {
    ...
    await assert.rejects(
      ...
      new CommandError('404 - "404 FILE NOT FOUND"'),
    );
  });
  ...
  it("configures command types", () => {
    assert.notStrictEqual(
      typeof command.types,
      "undefined",
      "command types undefined",
    );
    assert.notStrictEqual(
      command.types.string,
      "undefined",
      "command string types undefined",
    );
  });
  ...
  it("configures classification as string option", () => {
    ...
    ["classification"].forEach((o) => {
      assert.notStrictEqual(
        (types.string as string[]).indexOf(o),
        -1,
        `option ${o} not specified as string`,
      );
    });
  });
