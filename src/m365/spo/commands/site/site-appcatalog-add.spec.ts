...
describe(commands.SITE_APPCATALOG_ADD, () => {
  ...
  it("has correct name", () => {
    assert.strictEqual(
      command.name.startsWith(commands.SITE_APPCATALOG_ADD),
      true,
    );
  });
  ...
  it("creates site collection app catalog (debug=false)", async () => {
    ...
    await command.action(logger, {
      options: { siteUrl: "https://contoso.sharepoint.com/sites/site" },
    });
  });
            ...
            JSON.stringify([
              {
                ...
                ErrorInfo: {
                  ...
                  ErrorValue: null,
                  TraceCorrelationId: "d2d0389e-a040-4000-b24b-d16b0546a03c",
                  ErrorCode: -1,
