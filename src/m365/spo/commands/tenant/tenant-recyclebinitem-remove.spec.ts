...
describe(commands.TENANT_RECYCLEBINITEM_REMOVE, () => {
  ...
  afterEach(() => {
    sinonUtil.restore([request.post, global.setTimeout, Cli.prompt]);
  });
  ...
  it("passes validation if the url option is a valid SharePoint site URL", async () => {
    const actual = await command.validate(
      { options: { siteUrl: "https://contoso.sharepoint.com" } },
      commandInfo,
    );
    assert(actual);
  });
  ...
  it("removes the deleted site collection from the tenant recycle bin when prompt confirmed, doesn't wait for completion", async () => {
          ...
          return JSON.stringify([
            {
              ...
              LibraryVersion: "16.0.20614.12002",
              ErrorInfo: null,
              TraceCorrelationId: "5e0d879f-207a-2000-5eb4-5be71488a82a",
            },
            16,
            {
              IsNull: false,
            ...
            17,
            {
              ...
              _ObjectIdentity_:
                "5e0d879f-207a-2000-5eb4-5be71488a82a|908bed80-a04a-4433-b4a0-883d9847d110:1fdd85e0-9a94-4593-8ab0-5ad1b834475f\nSpoOperation\nRemoveDeletedSite\n637392077403920220\nhttps%3a%2f%2fcontoso.sharepoint.com%2fsites%2fhr\n67edbe85-2b95-4c7b-a34a-1abbcd68dbe4",
    ...
    await command.action(logger, {
      options: { siteUrl: "https://contoso.sharepoint.com/sites/hr" },
    });
      ...
      if (
        ...
        if (
          ...
          return JSON.stringify([
            {
              SchemaVersion: "15.0.0.0",
              LibraryVersion: "16.0.20509.12004",
              ErrorInfo: null,
              TraceCorrelationId: "47ac7b9f-6025-2000-3d94-fb3bb82b6a31",
            },
            39,
            {
              _ObjectType_:
                "Microsoft.Online.SharePoint.TenantAdministration.SpoOperation",
              _ObjectIdentity_:
                "47ac7b9f-6025-2000-3d94-fb3bb82b6a31|908bed80-a04a-4433-b4a0-883d9847d110:1fdd85e0-9a94-4593-8ab0-5ad1b834475f\nSpoOperation\nRemoveDeletedSite\n637361531422835228\nhttps%3a%2f%2fcontoso.sharepoint.com%2fsites%2fhr\n00000000-0000-0000-0000-000000000000",
              IsComplete: true,
          ...
          return JSON.stringify([
            {
              ...
              ErrorInfo: {
                ErrorMessage:
                  "Unable to find the deleted site: https:\u002f\u002fcontoso.sharepoint.com\u002fsites\u002fhr.",
                ErrorValue: null,
