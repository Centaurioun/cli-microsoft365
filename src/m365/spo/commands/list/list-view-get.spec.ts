...
describe(commands.LIST_VIEW_GET, () => {
  ...
  afterEach(() => {
    sinonUtil.restore([request.get, cli.getSettingWithDefaultValue]);
  });
  ...
  it("should successfully get the list view with specified its Id", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        opts.url ===
        `https://contoso.sharepoint.com/_api/web/lists/getByTitle('List%201')/views/getById('ba84217c-8561-4234-aa95-265081e74be9')`
      ) {
        if (
          opts.headers?.accept &&
          ...
          return {
            ...
            Hidden: false,
            HtmlSchemaXml:
              '<View Name="{BA84217C-8561-4234-AA95-265081E74BE9}" DefaultView="TRUE" MobileView="TRUE" MobileDefaultView="TRUE" Type="HTML" DisplayName="All Items" Url="/Lists/l2/AllItems.aspx" Level="1" BaseViewID="1" ContentTypeID="0x" ImageUrl="/_layouts/15/images/generic.png?rev=45"><Toolbar Type="Standard" /><XslLink Default="TRUE">main.xsl</XslLink><JSLink>clienttemplates.js</JSLink><RowLimit Paged="TRUE">30</RowLimit><ViewFields><FieldRef Name="LinkTitle" /></ViewFields><Query><OrderBy><FieldRef Name="ID" /></OrderBy></Query><ParameterBindings><ParameterBinding Name="NoAnnouncements" Location="Resource(wss,noXinviewofY_LIST)" /><ParameterBinding Name="NoAnnouncementsHowTo" Location="Resource(wss,noXinviewofY_DEFAULT)" /></ParameterBindings></View>',
            Id: "ba84217c-8561-4234-aa95-265081e74be9",
            ImageUrl: "/_layouts/15/images/generic.png?rev=45",
            ...
            RowLimit: 30,
            Scope: 0,
            ServerRelativePath: { DecodedUrl: "/Lists/l2/AllItems.aspx" },
            ServerRelativeUrl: "/Lists/l2/AllItems.aspx",
            StyleId: null,
            TabularView: true,
            Threaded: false,
            Title: "All Items",
    ...
    assert.strictEqual(
      loggerLogSpy.lastCall.args[0].Id,
      "ba84217c-8561-4234-aa95-265081e74be9",
    );
  });
  ...
  it("should successfully get the list view with specified its name", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        opts.url ===
        "https://contoso.sharepoint.com/_api/web/GetList('%2Flists%2FList1')/views/getByTitle('All%20Items')"
      ) {
        if (
          opts.headers?.accept &&
          (opts.headers.accept as string).indexOf("application/json") === 0
  ...
  it("should successfully get the list view with specified its name and list id", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        opts.url ===
        "https://contoso.sharepoint.com/_api/web/lists(guid'dac05e4a-5f6c-41dd-bba3-2be1104c711e')/views/getById('ba84217c-8561-4234-aa95-265081e74be9')"
      ) {
        if (
          opts.headers?.accept &&
          (opts.headers.accept as string).indexOf("application/json") === 0
    ...
    await command.action(logger, {
      options: {
        debug: true,
        webUrl: "https://contoso.sharepoint.com",
        listId: "dac05e4a-5f6c-41dd-bba3-2be1104c711e",
        id: "ba84217c-8561-4234-aa95-265081e74be9",
      },
    });
    assert.strictEqual(loggerLogSpy.lastCall.args[0].Title, "All Items");
  ...
  it("fails validation if webUrl is not a valid SharePoint URL", async () => {
    const actual = await command.validate(
      {
        options: { webUrl: "invalid", listTitle: "List 1", title: "All items" },
      },
      commandInfo,
    );
    ...
    const actual = await command.validate(
      {
        options: {
          webUrl: "https://contoso.sharepoint.com",
          listId: "330f29c5-5c4c-465f-9f4b-7903020ae1ce",
          id: "330f29c5-5c4c-465f-9f4b-7903020ae1cf",
        },
      },
      commandInfo,
    );
