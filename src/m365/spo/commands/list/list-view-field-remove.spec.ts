...
describe(commands.LIST_VIEW_FIELD_REMOVE, () => {
  ...
  afterEach(() => {
    sinonUtil.restore([request.get, request.post, Cli.prompt]);
  });
  ...
  it("removes the field by title from viewId and listTitle when prompt confirmed (debug)", async () => {
    ...
    sinon.stub(request, "post").callsFake(async (opts) => {
      ...
      if (
        (opts.url as string).indexOf(
          `https://contoso.sharepoint.com/sites/ninja/_api/web/lists/GetByTitle('Documents')/views('cc27a922-8224-4296-90a5-ebbc54da2e81')/viewfields/removeviewfield('Author')`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
    ...
    requests.forEach((r) => {
      if (
        r.url.indexOf(
          `/_api/web/lists/GetByTitle('Documents')/views('cc27a922-8224-4296-90a5-ebbc54da2e81')/viewfields/removeviewfield('`,
        ) > -1 &&
        r.headers.accept &&
  ...
  it("removes the field by title from viewTitle and listTitle", async () => {
    ...
    sinon.stub(request, "post").callsFake(async (opts) => {
      ...
      if (
        (opts.url as string).indexOf(
          `https://contoso.sharepoint.com/sites/ninja/_api/web/lists/GetByTitle('Documents')/views/GetByTitle('MyView')/viewfields/removeviewfield('Author')`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
    ...
    requests.forEach((r) => {
      if (
        r.url.indexOf(
          `/_api/web/lists/GetByTitle('Documents')/views/GetByTitle('MyView')/viewfields/removeviewfield('`,
        ) > -1 &&
        r.headers.accept &&
        r.headers.accept.indexOf("application/json") === 0
      ) {
  ...
  it("removes the field by title from viewTitle and listId when prompt confirmed", async () => {
    ...
    sinon.stub(request, "post").callsFake(async (opts) => {
      ...
      if (
        (opts.url as string).indexOf(
          `https://contoso.sharepoint.com/sites/ninja/_api/web/lists(guid'0cd891ef-afce-4e55-b836-fce03286cccf')/views/GetByTitle('MyView')/viewfields/removeviewfield('Author')`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
    ...
    requests.forEach((r) => {
      if (
        r.url.indexOf(
          `/_api/web/lists(guid'0cd891ef-afce-4e55-b836-fce03286cccf')/views/GetByTitle('MyView')/viewfields/removeviewfield('`,
        ) > -1 &&
        r.headers.accept &&
        r.headers.accept.indexOf("application/json") === 0
      ) {
  ...
  it("removes the field by title from viewId and listId when prompt confirmed", async () => {
    ...
    sinon.stub(request, "post").callsFake(async (opts) => {
      ...
      if (
        (opts.url as string).indexOf(
          `https://contoso.sharepoint.com/sites/ninja/_api/web/lists(guid'0cd891ef-afce-4e55-b836-fce03286cccf')/views('cc27a922-8224-4296-90a5-ebbc54da2e81')/viewfields/removeviewfield('Author')`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
    ...
    requests.forEach((r) => {
      if (
        r.url.indexOf(
          `/_api/web/lists(guid'0cd891ef-afce-4e55-b836-fce03286cccf')/views('cc27a922-8224-4296-90a5-ebbc54da2e81')/viewfields/removeviewfield('`,
        ) > -1 &&
        r.headers.accept &&
        r.headers.accept.indexOf("application/json") === 0
      ) {
  ...
  it("removes the field by id from viewId and listUrl when prompt confirmed", async () => {
    ...
    sinon.stub(request, "post").callsFake(async (opts) => {
      ...
      if (
        (opts.url as string).indexOf(
          `https://contoso.sharepoint.com/sites/ninja/_api/web/GetList('%2Fsites%2Fninja%2FShared%20Documents')/views('cc27a922-8224-4296-90a5-ebbc54da2e81')/viewfields/removeviewfield('Author')`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
    ...
    requests.forEach((r) => {
      if (
        r.url.indexOf(
          `/_api/web/GetList('%2Fsites%2Fninja%2FShared%20Documents')/views('cc27a922-8224-4296-90a5-ebbc54da2e81')/viewfields/removeviewfield('`,
        ) > -1 &&
        r.headers.accept &&
        r.headers.accept.indexOf("application/json") === 0
      ) {
