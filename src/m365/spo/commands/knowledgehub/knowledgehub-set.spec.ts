...
describe(commands.KNOWLEDGEHUB_SET, () => {
        ...
        if (opts.headers?.["X-RequestDigest"] && opts.data) {
          if (
            ...
            return JSON.stringify([
              ...
              { IsNull: false },
              33,
              'The knowledge hub site with url "https://contoso.sharepoint.com/sites/knowledgesite" is added to list.',
            ]);
          }
        }
      }
  ...
  it("sets the Knowledgehub Site", async () => {
    await command.action(logger, {
      options: {
        siteUrl: "https://contoso.sharepoint.com/sites/knowledgesite",
      },
    });
