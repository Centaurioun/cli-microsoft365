...
describe(commands.FIELD_REMOVE, () => {
  ...
  it("prompts before removing field when confirmation argument not passed (title)", async () => {
    await command.action(logger, {
      options: { title: "myfield1", webUrl: "https://contoso.sharepoint.com" },
    });
    let promptIssued = false;
  ...
  it("aborts removing field when prompt not confirmed and passing the group parameter", async () => {
    ...
    await command.action(logger, {
      options: { group: "MyGroup", webUrl: "https://contoso.sharepoint.com" },
    });
    assert(requests.length === 0);
  });
  ...
  it("removes the field when prompt confirmed", async () => {
    ...
    requests.forEach((r) => {
      if (
        r.url.indexOf(`/_api/web/fields/getbyid('`) > -1 &&
        r.headers.accept &&
    ...
    await assert.rejects(
      command.action(logger, {
        options: {
          ...
          id: "03e45e84-1992-4d42-9116-26f756012634",
          listUrl: "Lists/Events",
          confirm: true,
        },
      }),
    );
    assert.strictEqual(
      getStub.lastCall.args[0].url,
      "https://contoso.sharepoint.com/sites/portal/_api/web/GetList('%2Fsites%2Fportal%2FLists%2FEvents')/fields/getbyid('03e45e84-1992-4d42-9116-26f756012634')",
    );
  });
  ...
  it("calls group and deletes two fields and asks for confirmation", async () => {
    ...
    const getStub = sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        opts.url ===
        `https://contoso.sharepoint.com/sites/portal/_api/web/GetList(\'%2Fsites%2Fportal%2FLists%2FEvents\')/fields`
      ) {
        return {
          value: [
            {
    ...
    const deletion = sinon.stub(request, "post").callsFake(async (opts) => {
      if (
        (opts.url as string).indexOf(
          `/_api/web/GetList(\'%2Fsites%2Fportal%2FLists%2FEvents\')/fields/getbyid(\'03e45e84-1992-4d42-9116-26f756012634\')`,
        ) > -1
      ) {
        return {
          Id: "03e45e84-1992-4d42-9116-26f756012634",
      ...
      if (
        (opts.url as string).indexOf(
          `/_api/web/GetList(\'%2Fsites%2Fportal%2FLists%2FEvents\')/fields/getbyid(\'03e45e84-1992-4d42-9116-26f756012635\')`,
        ) > -1
      ) {
        return {
          Id: "03e45e84-1992-4d42-9116-26f756012635",
    ...
    await command.action(logger, {
      options: {
        ...
        webUrl: "https://contoso.sharepoint.com/sites/portal",
        group: "MyGroup",
        listUrl: "/sites/portal/Lists/Events",
      },
    });
    assert(getStub.called);
    assert.strictEqual(
      deletion.firstCall.args[0].url,
      "https://contoso.sharepoint.com/sites/portal/_api/web/GetList('%2Fsites%2Fportal%2FLists%2FEvents')/fields/getbyid('03e45e84-1992-4d42-9116-26f756012634')",
    );
    assert.strictEqual(
      deletion.secondCall.args[0].url,
      "https://contoso.sharepoint.com/sites/portal/_api/web/GetList('%2Fsites%2Fportal%2FLists%2FEvents')/fields/getbyid('03e45e84-1992-4d42-9116-26f756012635')",
    );
  ...
  it("calls group and deletes two fields", async () => {
    const getStub = sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        opts.url ===
        `https://contoso.sharepoint.com/sites/portal/_api/web/fields`
      ) {
        return {
          value: [
            {
    ...
    const deletion = sinon.stub(request, "post").callsFake(async (opts) => {
      if (
        (opts.url as string).indexOf(
          `/_api/web/fields/getbyid(\'03e45e84-1992-4d42-9116-26f756012634\')`,
        ) > -1
      ) {
        return {
          Id: "03e45e84-1992-4d42-9116-26f756012634",
      ...
      if (
        (opts.url as string).indexOf(
          `/_api/web/fields/getbyid(\'03e45e84-1992-4d42-9116-26f756012635\')`,
        ) > -1
      ) {
        return {
          Id: "03e45e84-1992-4d42-9116-26f756012635",
    ...
    assert.strictEqual(
      deletion.firstCall.args[0].url,
      "https://contoso.sharepoint.com/sites/portal/_api/web/fields/getbyid('03e45e84-1992-4d42-9116-26f756012634')",
    );
    assert.strictEqual(
      deletion.secondCall.args[0].url,
      "https://contoso.sharepoint.com/sites/portal/_api/web/fields/getbyid('03e45e84-1992-4d42-9116-26f756012635')",
    );
    assert.strictEqual(deletion.callCount, 2);
  });
  ...
  it("calls the correct get url when field title and list title specified (verbose)", async () => {
    ...
    assert.strictEqual(
      getStub.lastCall.args[0].url,
      "https://contoso.sharepoint.com/sites/portal/_api/web/lists/getByTitle('Documents')/fields/getbyinternalnameortitle('Title')",
    );
  });
  ...
  it("calls the correct get url when field title and list url specified", async () => {
    ...
    await command.action(logger, {
      options: {
        ...
        webUrl: "https://contoso.sharepoint.com/sites/portal",
        title: "Title",
        listId: "03e45e84-1992-4d42-9116-26f756012634",
        confirm: true,
      },
    });
    assert.strictEqual(
      getStub.lastCall.args[0].url,
      "https://contoso.sharepoint.com/sites/portal/_api/web/lists(guid'03e45e84-1992-4d42-9116-26f756012634')/fields/getbyinternalnameortitle('Title')",
    );
  });
  ...
  it("correctly handles list column not found", async () => {
    sinon.stub(request, "post").callsFake(async (opts) => {
      if (
        (opts.url as string).indexOf(
          `/_api/web/lists/getByTitle('Documents')/fields/getbyid(`,
        ) > -1
      ) {
        throw {
          error: {
            "odata.error": {
              ...
              message: {
                lang: "en-US",
                value:
                  "Invalid field name. {03e45e84-1992-4d42-9116-26f756012634}  /sites/portal/Shared Documents",
              },
            },
          },
        };
          ...
          error: {
            "odata.error": {
              ...
              message: {
                lang: "en-US",
                value:
                  "List 'Documents' does not exist at site with URL 'https://contoso.sharepoint.com/sites/portal'.",
              },
            },
          },
        };
