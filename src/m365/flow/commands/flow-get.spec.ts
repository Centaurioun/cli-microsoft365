...
describe(commands.GET, () => {
  ...
  it("retrieves information about the specified flow (debug)", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        (opts.url as string).indexOf(
          `providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows/3989cb59-ce1a-4a5c-bb78-257c5c39381d?api-version=2016-11-01`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
          ...
          return {
            ...
            properties: {
                ...
                actions: {
                  Check_if_there_were_any_posts_this_week: {
                    actions: {
                      Compose_the_links_for_each_blog_post: {
                        ...
                        actions: {
                          Compose: {
                            ...
                            type: "Compose",
                            inputs:
                              "<tr><td><h3><a href=\"@{item()?['primaryLink']}\">@{item()['title']}</a></h3></td></tr><tr><td style=\"color: #777777;\">Posted at @{formatDateTime(item()?['publishDate'], 't')} GMT</td></tr><tr><td>@{item()?['summary']}</td></tr>",
                          },
                        },
                        runAfter: {},
                        type: "Foreach",
                      ...
                      Send_an_email: {
                        runAfter: {
                          Compose_the_links_for_each_blog_post: ["Succeeded"],
                        },
                        metadata: {
                          flowSystemMetadata: {
                        ...
                        inputs: {
                          body: {
                            notificationBody:
                              "<h2>Check out the latest news from CNN:</h2><table>@{join(outputs('Compose'),'')}</table>",
                            notificationSubject:
                              "Daily digest from CNN top news",
                          },
                          host: {
                            api: {
                              runtimeUrl:
                  ...
                  Filter_array: {
                    runAfter: {
                      List_all_RSS_feed_items: ["Succeeded"],
                    },
                    type: "Query",
                    inputs: {
                      from: "@body('List_all_RSS_feed_items')",
                      where:
                        "@greater(item()?['publishDate'], adddays(utcnow(),-2))",
                    },
                  },
              ...
              connectionReferences: {
                shared_rss: {
                  connectionName:
                    "shared-rss-6636bfd3-0d29-4842-b835-c5910b6310f6",
                  apiDefinition: {
                    name: "shared_rss",
                    ...
                    paths: {
                      "/{connectionId}/OnNewFeed": {
                        get: {
                          ...
                          "x-ms-trigger": "batch",
                          "x-ms-trigger-hint":
                            "To see it work now, publish an item to the RSS feed.",
                        },
                      },
                ...
                shared_flowpush: {
                  connectionName:
                    "shared-flowpush-295e4b80-1a4e-42ec-aa5b-8d72e7c1eb3f",
                  apiDefinition: {
                    ...
                    properties: {
                      ...
                      iconUri:
                        "https://psux.azureedge.net/Content/Images/Connectors/FlowNotification.svg",
                      purpose: "NotSpecified",
                      connectionParameters: {},
                      runtimeUrls: [
                        "https://europe-001.azure-apim.net/apim/flowpush",
                  ...
                  swagger: {
                    ...
                    definitions: {
                      ...
                      NotificationEmailDefinition: {
                        type: "object",
                        required: ["notificationSubject", "notificationBody"],
                        properties: {
                          notificationSubject: {
                    ...
                    paths: {
                      "/{connectionId}/sendNotification": {
                        post: {
                          description:
                            "Sends a push notification to your Microsoft Flow mobile app.",
                      ...
                      "/{connectionId}/sendEmailNotification": {
                        post: {
                          description:
                            "Sends an email notification to the account you signed in to Microsoft Flow with.",
              ...
              flowTriggerUri:
                "https://management.azure.com:443/providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows/3989cb59-ce1a-4a5c-bb78-257c5c39381d/triggers/Every_day/run?api-version=2016-11-01",
    ...
    assert(
      loggerLogSpy.calledWith({
            ...
            shared_rss: {
              ...
              apiDefinition: {
                ...
                properties: {
                  ...
                  runtimeUrls: ["https://europe-001.azure-apim.net/apim/rss"],
                  primaryRuntimeUrl:
                    "https://europe-001.azure-apim.net/apim/rss",
                  metadata: {
                    source: "marketplace",
        ...
        triggers: "Recurrence",
        actions:
          "If, Query, ApiConnection-ListFeedItems, Foreach, ApiConnection-SendEmailNotification, Compose",
      }),
    );
  });
                ...
                triggers: [
                  {
                    ...
                    metadata: {
                      operationMetadataId:
                        "a35030f3-0e3c-4501-aeba-0c9fb1b1d674",
                    },
                  },
                ],
                actions: [
  ...
  it("retrieves information about the specified flow as admin", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        (opts.url as string).indexOf(
          `providers/Microsoft.ProcessSimple/scopes/admin/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows/3989cb59-ce1a-4a5c-bb78-257c5c39381d?api-version=2016-11-01`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
  ...
  it("correctly handles Flow not found", async () => {
    sinon.stub(request, "get").rejects({
      error: {
        ...
        message:
          "The caller with object id 'da8f7aea-cf43-497f-ad62-c2feae89a194' does not have permission for connection '1c6ee23a-a835-44bc-a4f5-462b658efc12' under Api 'shared_logicflows'.",
      },
    });
    ...
    await assert.rejects(
      command.action(logger, {
        options: {
          environmentName: "Default-d87a7535-dd31-4437-bfe1-95340acd55c6",
          name: "1c6ee23a-a835-44bc-a4f5-462b658efc12",
        },
      } as any),
      new CommandError(
        `The caller with object id 'da8f7aea-cf43-497f-ad62-c2feae89a194' does not have permission for connection '1c6ee23a-a835-44bc-a4f5-462b658efc12' under Api 'shared_logicflows'.`,
  ...
  it("correctly handles Flow not found (as admin)", async () => {
    ...
    await assert.rejects(
      ...
      new CommandError(
        `Could not find flow '1c6ee23a-a835-44bc-a4f5-462b658efc12'.`,
      ),
    );
  });
