...
describe(commands.LIST, () => {
    ...
    value: [
      {
        ...
        properties: {
          ...
          definitionSummary: {
            ...
            description:
              "Use this template to send yourself a custom delayed reminder which can be triggered with a button tap - for example, when you are close to completing a meeting or when you step into the office.",
          },
          creator: {
      ...
      },
      {
        ...
        properties: {
          ...
          definitionSummary: {
            ...
            description:
              "Each day, get an email with a list of all of the top CNN posts from the last day.",
          },
          creator: {
            tenantId: "d87a7535-dd31-4437-bfe1-95340acd55c5",
            objectId: "da8f7aea-cf43-497f-ad62-c2feae89a194",
  ...
  it("fails validation if sharingStatus is not a valid sharingstatus", async () => {
    const actual = await command.validate(
      { options: { environmentName: environmentId, sharingStatus: "invalid" } },
      commandInfo,
    );
    assert.notStrictEqual(actual, true);
  });
  ...
  it("passes validation if sharingStatus is valid", async () => {
    const actual = await command.validate(
      { options: { environmentName: environmentId, sharingStatus: "all" } },
      commandInfo,
    );
  ...
  it("passes validation if asAdmin is passed", async () => {
    const actual = await command.validate(
      { options: { environmentName: environmentId, asAdmin: true } },
      commandInfo,
    );
    assert.strictEqual(actual, true);
  });
  ...
  it("retrieves available Flows (debug)", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        (opts.url as string).indexOf(
          `providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows?api-version=2016-11-01`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
    ...
    await command.action(logger, {
      options: {
        debug: true,
        environmentName: "Default-d87a7535-dd31-4437-bfe1-95340acd55c5",
      },
    });
    assert(
  ...
  it("retrieves available Flows when specifying sharingStatus ownedByMe", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        opts.url ===
        `https://management.azure.com/providers/Microsoft.ProcessSimple/environments/${environmentId}/flows?api-version=2016-11-01`
      ) {
        return flowResponse;
      }
    ...
    await command.action(logger, {
      options: { environmentName: environmentId, sharingStatus: "ownedByMe" },
    });
  ...
  it("retrieves available Flows when specifying sharingStatus all", async () => {
    const getStub = sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        opts.url ===
        `https://management.azure.com/providers/Microsoft.ProcessSimple/environments/${environmentId}/flows?api-version=2016-11-01&$filter=search('team')`
      ) {
        return flowResponse;
      }
      if (
        opts.url ===
        `https://management.azure.com/providers/Microsoft.ProcessSimple/environments/${environmentId}/flows?api-version=2016-11-01&$filter=search('personal')`
      ) {
        return flowResponse;
      }
  ...
  it("retrieves available Flows when specifying sharingStatus personal", async () => {
    ...
    await command.action(logger, {
      options: { environmentName: environmentId, sharingStatus: "personal" },
    });
    assert(loggerLogSpy.calledWith(flowResponse.value));
  });
    ...
    sinon.stub(request, "get").callsFake(async (opts) => {
      if ((opts.url as string).indexOf("skiptoken") === -1) {
        if (
          ...
          return {
            nextLink:
              "https://management.azure.com/providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows?api-version=2016-11-01&%24skiptoken=eyJuZXh0TWFya2VyIjoiMjAxOTAyMDRUMTg1NDU2Wi02YTA5NGQwMi02NDFhLTQ4OTEtYjRkZi00NDA1OTRmMjZjODUifQ%3d%3d",
            value: [
              {
                name: "1c6ee23a-a835-44bc-a4f5-462b658efc13",
                id: "/providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows/1c6ee23a-a835-44bc-a4f5-462b658efc13",
  ...
  it("retrieves available Flows as admin", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        (opts.url as string).indexOf(
          `providers/Microsoft.ProcessSimple/scopes/admin/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows?api-version=2016-11-01`,
        ) > -1
      ) {
        if (
          opts.headers?.accept &&
    ...
    sinon.stub(request, "get").callsFake(async (opts) => {
      if ((opts.url as string).indexOf("skiptoken") === -1) {
        if (
          ...
          return {
            nextLink:
              "https://emea.api.flow.microsoft.com:11777/providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows?api-version=2016-11-01&%24skiptoken=eyJuZXh0TWFya2VyIjoiMjAxOTAyMDRUMTg1NDU2Wi02YTA5NGQwMi02NDFhLTQ4OTEtYjRkZi00NDA1OTRmMjZjODUifQ%3d%3d",
            value: [
              {
                name: "1c6ee23a-a835-44bc-a4f5-462b658efc13",
                id: "/providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows/1c6ee23a-a835-44bc-a4f5-462b658efc13",
        ...
        if (
          (opts.url as string).indexOf(
            "https://emea.api.flow.microsoft.com:11777",
          ) > -1
        ) {
          throw "Invalid request";
        }
  ...
  it("retrieves flows including flows from solutions", async () => {
    sinon.stub(request, "get").callsFake(async (opts) => {
      if (
        opts.url ===
        "https://management.azure.com/providers/Microsoft.ProcessSimple/environments/${environmentId}/flows?api-version=2016-11-01&include=includeSolutionCloudFlows"
      ) {
        return {
          value: [
            {
    ...
    sinon.stub(request, "get").callsFake(async (opts) => {
      if ((opts.url as string).indexOf("skiptoken") === -1) {
        if (
          ...
          return {
            nextLink:
              "https://management.azure.comproviders/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows?api-version=2016-11-01&%24skiptoken=eyJuZXh0TWFya2VyIjoiMjAxOTAyMDRUMTg1NDU2Wi02YTA5NGQwMi02NDFhLTQ4OTEtYjRkZi00NDA1OTRmMjZjODUifQ%3d%3d",
            value: [
              {
                name: "1c6ee23a-a835-44bc-a4f5-462b658efc13",
                id: "/providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows/1c6ee23a-a835-44bc-a4f5-462b658efc13",
