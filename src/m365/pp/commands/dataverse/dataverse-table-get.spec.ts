...
describe(commands.DATAVERSE_TABLE_GET, () => {
  ...
  it("retrieves data for a specific dataverse table", async () => {
    ...
    await command.action(logger, {
      options: { debug: true, environment: validEnvironment, name: validName },
    });
  ...
  it("correctly handles API OData error", async () => {
    ...
    await assert.rejects(
      command.action(logger, {
        options: { environment: validEnvironment, name: validName },
      } as any),
      new CommandError(
