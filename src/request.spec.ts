...
describe("Request", () => {
  ...
  beforeEach(() => {
    ...
    sinon
      .stub(auth, "ensureAccessToken")
      .callsFake(() => Promise.resolve("ABC"));
  });
    ...
    _request
      ...
      .then(
        ...
        () => {
          try {
            assert(
              (_options as any).headers["user-agent"].indexOf(
                "NONISV|SharePointPnP|CLIMicrosoft365",
              ) > -1,
            );
            done();
          } catch (err) {
    ...
    _request
      ...
      .then(
        ...
        () => {
          try {
            assert(
              (_options as any).headers["accept-encoding"].indexOf("gzip") > -1,
            );
            done();
          } catch (err) {
            done(err);
    ...
    _request
      ...
      .then(
        ...
        () => {
          try {
            assert(
              (_options as any).headers["authorization"].indexOf("Bearer ABC") >
                -1,
            );
            done();
          } catch (err) {
    ...
    _request
      ...
      .then(
        ...
        () => {
          try {
            assert.strictEqual(
              typeof (_options as any).headers["authorization"],
              "undefined",
            );
            done();
          } catch (err) {
    ...
    _request
      ...
      .then(
        ...
        () => {
          try {
            assert.strictEqual(
              typeof (_options as any).headers["x-anonymous"],
              "undefined",
            );
            done();
          } catch (err) {
    ...
    _request
      ...
      .then(
        ...
        () => {
          try {
            assert.strictEqual(
              typeof (_options as any).headers["x-resource"],
              "undefined",
            );
            done();
          } catch (err) {
      ...
      .then(
        () => {
          try {
            assert(
              logSpy.calledWith(
                "Request throttled. Waiting 10sec before retrying...",
              ),
            );
            done();
          } catch (err) {
